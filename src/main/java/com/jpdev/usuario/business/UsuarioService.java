...
public class UsuarioService {
   ...
   public void deleteUsuarioPorEmail(String email){
    ...
    public UsuarioDTO atualizaDadosUsuario(String token, UsuarioDTO dto){
        ...
        Usuario usuarioEntity = usuarioRepository.findByEmail(email).orElseThrow(() -> new ResourceNotFoundException("Email não econtrado"));
    ...
    public TelefoneDTO atualizaTelefone(long idTelefone, TelefoneDTO telefoneDTO){
        Telefone telefoneEntity = telefoneRepository.findById(idTelefone).orElseThrow(() -> new ResourceNotFoundException("Id não econtrado " + idTelefone));
